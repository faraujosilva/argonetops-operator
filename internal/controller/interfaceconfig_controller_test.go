...
var _ = Describe("InterfaceConfig Controller", func() {
	Context("When reconciling a resource", func() {
		...
		interfaceconfig := &networkv1alpha1.InterfaceConfig{}

		BeforeEach(func() {
			By("creating the custom resource for the Kind InterfaceConfig")
			err := k8sClient.Get(ctx, typeNamespacedName, interfaceconfig)
		...
		AfterEach(func() {
			...
			By("Cleanup the specific resource instance InterfaceConfig")
